...
if (!isset($_SESSION["autoriser"]) || $_SESSION["autoriser"] != "oui" ||!isset($_SESSION["idAdministrateur"])) { 
    ...
    $nomAdministrateur = $_SESSION["Nom"] ?? 'Administrateur';
...
<head> 
    <meta charset="utf-8" /> 
     <title>Espace d'Administrateur</title>
...
<body> 
   <div class="container">
        <h2>Bienvenue <?php echo htmlspecialchars($nomAdministrateur); ?> </h2> 
        ...
        <div class="role-specific-content">
               ...
               <h3>Votre Espace Administrateur</h3>
                <p>Gérez les utilisateurs et les paramètres du système.</p>
                 <ul>
                    <li><a href="page1.php">Gestion des comptes</a></li>
