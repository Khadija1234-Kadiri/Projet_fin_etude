...
<body> 
   <div class="container">
        <h2>Bienvenue <?php echo htmlspecialchars($nomEtudiant); ?> </h2> 

        <div class="role-specific-content">
           
                <h3>Votre Espace Étudiant</h3>
                <p>Ici, vous pouvez consulter vos informations, déposer votre PFE, voir les feedbacks, etc.</p>
                <ul>
                    <li><a href="#">Mes informations</a></li>
                    <li><a href="#">Déposer mon PFE</a></li>
                    <li><a href="#">Consulter les feedbacks</a></li>
                     <li><a href="chercherPFE.php">Rechercher Exemples PFE / Ressources</a></li>
                </ul>
