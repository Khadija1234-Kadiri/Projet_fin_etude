...
if (!isset($_SESSION["autoriser"]) || $_SESSION["autoriser"] != "oui" || !isset($_SESSION["idResponsable"])) {
    // Rediriger vers la page d'authentification si l'utilisateur n'est pas un responsable PFE autorisé
    header("location:AuthentificationResponsable.php"); // ou index.php si c'est votre page de login principale
    exit();
}

// Récupérer le nom du responsable depuis la session pour un message d'accueil personnalisé
$nomResponsable = $_SESSION["prenomNom"] ?? 'Responsable PFE'; // Valeur par défaut si non défini
...
<body>
    ...
    <div class="app">
        ...
        <aside class="sidebar">
            <h3>Menu</h3>
            <nav class="menu">
                <a href="RespoPFE.php" class="menu-item is-active">Home</a>
                <a href="PartagerListRes.php" class="menu-item">Partager la liste Encadrant / Groupe d'étudiant</a>
 ...
 <main class="content">
            <h1>Tableau de Bord Responsable PFE </h1>
            <p>Bienvenue, <?php echo htmlspecialchars($nomResponsable); ?></p>
